...
::: callout-note
## Alternatively, we can conduct a stepwsie regression to identify the more significant independent variables.
:::
...
::: callout-note
## We conduct this 2nd round of multicollinearity check after fitting the lm model by using the VIF measure.
:::
...
The report shows that the AICc of the gwr is 42263.61 which is significantly smaller than the global multiple linear regression model of 42967.14.
